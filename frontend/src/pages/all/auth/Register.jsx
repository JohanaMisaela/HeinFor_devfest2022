              ...
              <div className="col-md-6 col-lg-7 d-flex align-items-center">
                <div className="card-body p-4 p-lg-5 text-black">
                  ...
                  <div>
                    ...
                    <h5 className="fw-normal mb-3 pb-3" style={{letterSpacing: 1+"px"}}>Créer un compte</h5>
                  
                    <div className="form-outline mb-4">
                      <input name="login" type="Name" id="form2Example17" 
                      className="form-control form-control-lg" placeholder="Nom" 
                      required
                      value={name}
                    ...
                    <div className="form-outline mb-4">
                      <input name="login" type="Name" id="form2Example17" 
                      className="form-control form-control-lg" placeholder="Prenom" 
                      required
                      value={firstName}
                    ...
                    <div className="form-outline mb-4">
                      <input name="login" type="Name" id="form2Example17" 
                      className="form-control form-control-lg" placeholder="Quartier" 
                      required
                      value={quartier}
                    ...
                    <div className="pt-1 mb-4">
                      <button className="btn btn-dark btn-lg btn-block" type="submit" name="connect">S'inscrire</button>
                    </div>
  
                    <p className="mb-5 pb-lg-2" style={{color: "#393f81"}}>Vous avez déja un compte?
                    <a href="/login" className="text-info">Se connecter</a></p>
