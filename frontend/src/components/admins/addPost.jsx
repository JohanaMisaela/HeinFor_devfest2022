  ...
  return (
    ...
    <div className="card my-4 mycard mx-auto mt-5" data-aos="fade-up">
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="card-body p-4">
                <textarea cols="60" rows="3" className='form-control' placeholder="Qu'en pensez vous..."
                value={text}
            ...
            <input
                        ...
                        />
                        {
                            file && <button className='btn btn-danger' onClick={cancelPicture}>cancel photo</button>
                        }
            </div> 
            <div className="text-center"><hr/></div>
            {
                ...
                <div className="row comment px-4 text-center">
                    <p className="btn btn-danger" onClick={cancelPost}>Cancel </p>
                </div>
